...
load_file_name = "OHD_Complete_lüdenscheid"
...
def update_graph(value):
    ...
    fig = heatmap_corpus(top_dic, option_selected=str(value),z_score = False,show_fig=False, return_fig=True)
    return fig
...
def interview_heat_map(clickData, interview_manual_id):
    global interview_id
